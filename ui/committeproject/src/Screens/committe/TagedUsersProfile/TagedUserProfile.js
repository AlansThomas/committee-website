...
import CommitteePost from "../CommitteePosts/CommitteePost";
import profileStyles from "./TagedUserProfile.module.css";

export default function TagedUserProfile({ re }) {
  ...
  const [DataID, setDataId] = useState(variable);
  ...
  if (errorData) {
    componentToRender = newFunction(getevent, data, errorData);
    ...
    <div className={profileStyles.pro}>
      <div className={profileStyles.proWrapper} onScroll={getevent}>
        ...
        <div className={profileStyles.feeds}>
          ...
          {<CommitteePost props={tag} reoad={tagged} />}
        </div>
      </div>
    </div>
  );
...
function newFunction(getevent, data, errorData) {
  return (
    <div className={profileStyles.pro}>
      <div className={profileStyles.proWrapper} onScroll={getevent}>
        <div className={profileStyles.profile}>
